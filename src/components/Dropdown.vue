<template>
  <div class="relative">
    ...
    // This code creates a button with class "fixed inset-0 h-full w-full cursor-default focus:outline-none" that is visible only if the variable "open" is true. 
    // When the button is clicked, the variable "open" is set to false. The tabindex is set to "-1".
